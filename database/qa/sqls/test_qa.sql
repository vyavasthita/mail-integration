...
BEGIN
    ...
    ELSE
        SELECT CONCAT('Index ','sender ','already exists on Table ', 'testdb_qa','.','email_sender');   
    END IF;
    ...
    ELSE
        SELECT CONCAT('Index ','receiver ','already exists on Table ', 'testdb_qa','.','email_receiver');   
    END IF;
    ...
    ELSE
        SELECT CONCAT('Index ','subject ','already exists on Table ', 'testdb_qa','.','email_subject');   
    END IF;
    ...
    ELSE
        SELECT CONCAT('Index ','content ','already exists on Table ', 'testdb_qa','.','email_content');   
    END IF;
